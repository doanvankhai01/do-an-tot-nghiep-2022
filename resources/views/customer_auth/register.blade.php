                     ...
                     <?php
                        ...
                        ?>
                                ...
                                <form action="{{url('/register')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="text" name="admin_name" class="form-control admin_name" value="{{old('admin_name')}}" id="admin_name" onkeyup="" placeholder="Tên quản trị viên">
                    
                                    <label class="lable-title">Đường dẫn URL</label>
                                    <input type="text" name="admin_slug" class="form-control admin_slug" value="{{old('admin_slug')}}" id="admin_slug" placeholder="ten-quan-tri-vien">
                            
                                    <label class="lable-title">Ngày sinh</label>
                                    <input type="text" name="admin_birdthday" class="form-control admin_birdthday" value="{{old('admin_birdthday')}}" id="datepicker3" placeholder="dd-mm-yyyy">
                            
                                    <label class="lable-title">Địa chỉ</label>
                                    <input type="text" name="admin_address" class="form-control admin_address" value="{{old('admin_address')}}" id="admin_address" placeholder="VN">
                                
                                    <label class="lable-title">Số điện thoại</label>
                                    <input type="text" name="admin_phone" class="form-control admin_phone" value="{{old('admin_phone')}}" id="admin_phone" placeholder="+(81)">
                                
                                    <label class="lable-title">Hình ảnh</label>
                                    <input type="file" id="admin_file" class="btn-function-infomation" value="" style="width: 100%" name="admin_image">
                                    ...
                                    <select name="admin_status" class="form-control input-sm m-bot15  admin_status">
                                    ...
                                    <input type="submit" name="register" class="btn-submit-function add_admin" onmousemove="validation_brand();"><i class="fa fa-plus"></i> Thêm Thương hiệu</button>
                                </form>
